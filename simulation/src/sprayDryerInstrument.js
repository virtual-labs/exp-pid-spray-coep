...
//					  $("#modelTitle1").html("Required configuration ");
						...
						+"<img src='images/sprayPartB.png' class='img-fluid' id='partB'  >"
						 $("#modelBody1").html(htm);
						  $("#modelBody1").css("color","red"); 
	...
	function CountComp1(){
		...
		if((ft==StdFTCount) && (tt==StdTTCount) && (vi==StdVICount) && (tshh==StdTSHHCount) && (pi==StdPICount) && (afr==StdAFRCount)
			...
			htm=''
				...
				+'<div class="col-sm-12" >'
				+"<img src='images/sprayPartB.png' class='img-fluid' id='partB1' >"
				+'</div>'
			  $("#diagram").html(htm);
			  $("#partB1").animate(
			          {
