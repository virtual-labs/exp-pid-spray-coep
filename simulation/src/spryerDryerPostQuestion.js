function spryerDryerPostQuestion(dataJson)
{
//	$("#Selection").html("");
//	$("#Header").html("	<center><span >GRAPH</span></center>");
	var htm=''
...
//	
//	+'   <span class="legend-icon icon-tt01"></span>'
//	+'  <span>Hot Air Temperature (TT01) : <b class="ticon-tt01" id="tt1"></b> °C</span>'
//	
//	+'    </div>'
//	+'   <div class="legend-item">'
//	+'      <span class="legend-icon icon-tt02"></span>'
//	+'      <span>Product Temperature (TT02) : <b class="ticon-tt02" id="tt2"></b> °C</span>'
//	+'    </div>'
//	+'    <div class="legend-item">'
//	+'      <span class="legend-icon icon-ft"></span>'
//	+'      <span>Flow Transmitter (FT) : <b class="ticon-ft" id="ft"></b> mBar</span>'
//	+'    </div>'
//	+'   <div class="legend-item">'
//	+'      <span class="legend-icon icon-nt"></span>'
//	+'     <span>Vacuum Transmitter (NT) : <b class="ticon-nt" id="nt"></b> mBar </span>'
//	+'   </div>'
//	
//	+'   <div class="legend-item">'
//	+'     <span class="legend-icon icon-p1-speed"></span>'
//	+'	      <span>Peristaltic Pump (PUMP_SPEED) : <b class="ticon-p1-speed" id="pump"></b> %</span>'
//	+'  </div>'
//	+'   <div class="legend-item">'
//	+'     <span class="legend-icon icon-fd-speed"></span>'
//	+'	      <span>FD_FAN (FD_SPEED) : <b class="ticon-fd-speed" id="fdfan"></b> %</span>'
//	+'  </div>'
//	+'	    <div class="legend-item">'
//	+'	      <span class="legend-icon icon-id-speed"></span>'
//	+'    <span>ID_FAN (ID_SPEED) : <b class="ticon-id-speed" id="idfan"></b> %</span>'
//	+'   </div>'
//	+'   <div class="legend-item">'
//	+'     <span class="legend-icon icon-heater"></span>'
//	+'    <span>Heater firing (HEATER) : <b class="ticon-heater" id="heater"></b> mBar</span>'
//	+'   </div>'
//	+'</div>'
...
//		                $("#nt").html(nt);
//		                $("#pump").html(P1_SPEED);
//		                $("#fdfan").html(FD_SPEEDPer);
//		                $("#idfan").html(ID_SPEEDPer);
//		                $("#heater").html(HeaterPer);
